...
const softSkills = [
  ...
  { name: "Teamwork", level: 92, category: "softskills" },
...
export const SkillsSection = () => {
  ...
  // Combine skills and softSkills for filtering
  const combinedSkills = [...skills, ...softSkills];

  const filteredSkills = combinedSkills.filter(
